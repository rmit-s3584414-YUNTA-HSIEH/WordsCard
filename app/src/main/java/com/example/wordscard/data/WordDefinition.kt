...
data class WordDefinition(
    ...
    //@field:Json(name = "phonetics") val phonetics: Phonetics,
    //@field:Json(name = "meanings") val meanings: Meanings
)
...
data class Meanings(
    ...
    @field:Json(name = "definitions") val definitions: Definitions
)
